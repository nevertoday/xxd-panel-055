...
# 🦁 XXD Panel 055｜حقل الذاكرة المرسوم

### تحويل الضوء والحركة والعلاقة المكانية إلى حكاية بصرية رقيقة
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091726763701555207"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 055 نموذج 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091726763701555207"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 055 نموذج 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091726763701555207"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 055 نموذج 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091726763701555207"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 055 نموذج 4"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 055 نموذج 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 055 نموذج 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 055 نموذج 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 055 نموذج 8"></td>
  </tr>
</table>

## نماذج إضافية 3:4 بتكوين أعلى–أسفل

تعيد هذه الأعمال الأربعة استخدام المصادر المستقلة نفسها في مجموعة 16:9 أعلاه، لكن داخل لوحات كاملة 3:4 بتكوين أعلى–أسفل. تبقى الصورة الواقعية في الأعلى، ويُعاد بناء التصميم السفلي وفق الموجّه الأصلي لـ Panel 055. لا يُولَّد النص الإنجليزي إلا من محتوى كل صورة أو مزاجها أو دلالتها، وقد روجعت النتائج واحدةً واحدة.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 055 نموذج إضافي أعلى–أسفل 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 055 نموذج إضافي أعلى–أسفل 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 055 نموذج إضافي أعلى–أسفل 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 055 نموذج إضافي أعلى–أسفل 4"></td>
  </tr>
</table>

> [Xiaoxiaodong (@xiaoxiaodong01)](https://x.com/xiaoxiaodong01/status/2091726763701555207) · 24 أغسطس 2026<br>
> GPT2 × صقل × ألوان مريحة × موجّه جمالي × VOL.055

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2091726763701555207">عرض المنشور الأصلي والتوجيه كاملاً ←</a></p>

تعرض هذه النماذج النتيجة الجمالية للإصدار 055 فقط؛ ولا تصبح موضوعاتها أو تكوينها أو ألوانها أو نصوصها أو نسبة اللوحة السابقة مراجع أو إعدادات افتراضية لمهمة جديدة.
...
يناسب **Panel 055** الأعمال التي تحتاج إلى الاحتفاظ بجوهر الصورة الأصلية مع السعي إلى هذا الاتجاه البصري: **تحويل الضوء والحركة والعلاقة المكانية إلى حكاية بصرية رقيقة**. يبدأ من الاستخدام المقصود والنتيجة المطلوبة، ثم يحدد التكوين والمقاس والنص وصيغة التسليم.
...
> استخدم XXD Panel 055 لهذه الصورة، واقترح أولاً أنسب تكوين ومقاس.
...
## تحقق سريع: هل XXD Panel 055 مناسب لك؟

| ما الذي يهمك؟ | ما الذي يقدمه هذا الأسلوب؟ |
|---|---|
| **النتيجة التي ستحصل عليها** | تحويل الضوء والحركة والعلاقة المكانية إلى حكاية بصرية رقيقة |
| **السمات التي تُعرف من النظرة الأولى** | سرد الموضوع · ألوان باستيل مريحة · ملمس زيتي خفيف · أزرق هوائي · فراغ تحريري |
...
يحدد الأسلوب أولاً أكثر موضوع وحركة وعلاقة مكانية قدرة على حمل السرد، ثم يحذف تفاصيل البيئة التي لا تخدمها. وهو ليس مرشح باستيل؛ بل إعادة تنظيم لعلامات الواقع القابلة للتعرّف في تكوين مرسوم ذي تراتبية ومسار قراءة واضح.

```text
تثبيت الهوية والمحيط والوضع والعلاقة ← اختيار العلامة السردية الأشد بقاءً ← ضغط المشهد ← بناء مركز بصري واحد ← إعادة الرسم بكتل باستيل وملمس زيتي خفيف ← حفظ الأزرق الهوائي والمحايدات الفاتحة ← دمج كتابة تحريرية قليلة
```

## سمات الأسلوب التي تظهر بوضوح في النتيجة

- تبقى هوية الموضوع ووضعه الأساسي وعلاقته السردية واضحة من دون نسخ الخلفية كاملة.
- يجمع السطح بين الغواش والأكريليك والباستيل وآثار سكين رسم مقتصدة ليبدو يدوياً ومضيئاً.
- تقود الدرجات الزرقاء الفاتحة والعاجي والكريمي والبيج، مع وردي مكتوم أو خوخي ناعم كلمسة صغيرة فقط.
- يكوّن الوضع اللامركزي أو التكبير أو الاقتصاص الجزئي مسار قراءة واضحاً عبر العمق والاتجاه والفراغ الهادئ.
- تبقى الكتابة صغيرة وخفيفة وتحريرية، ولا تنشأ إلا من محتوى الصورة الحالية أو دلالتها.

لا توجد القيود الجمالية وقواعد الرفض إلا في [الموجّه الأصلي](references/original-prompt/zh-CN.md)، أما المهارة ومهايئ التشغيل فيعالجان متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-055-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 055. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-055 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-055 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-055 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-055 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-055 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 055 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-055 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-055`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-055-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-055-prompt.zh-CN.md)
