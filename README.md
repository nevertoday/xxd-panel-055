...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091726763701555207"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 055 样张 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091726763701555207"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 055 样张 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091726763701555207"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 055 样张 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091726763701555207"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 055 样张 4"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 055 样张 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 055 样张 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 055 样张 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 055 样张 8"></td>
  </tr>
</table>

## 新增 3:4 上下双联样张

以下四张复用上方 16:9 样张对应的四张独立素材，重新生成完整 3:4 上下双联画布；上部保留现实摄影，下部遵循 055 原始提示词重构。英文配字只从当前照片的内容、情绪或隐喻中生成，并已逐张复核。

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 055 新增上下样张 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 055 新增上下样张 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 055 新增上下样张 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 055 新增上下样张 4"></td>
  </tr>
</table>

> [小小东（@xiaoxiaodong01）](https://x.com/xiaoxiaodong01/status/2091726763701555207) · 2026 年 8 月 24 日<br>
> GPT2 × 优化 × 治愈 × 美学提示词 × VOL.055

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2091726763701555207">查看原推文与完整提示词 →</a></p>

这些样张只展示 055 的审美结果；样张主体、构图、配色、文字和旧画幅不会成为新任务的参考或默认值。
...
**Panel 055** 适合这类任务：需要保留原图核心内容，同时希望最终视觉达到以下方向：**把一束光、一个动作与一个空间关系画成温柔的视觉叙事**。它先从用途与期望结果出发，再决定构图、尺寸、文字和具体输出形式。
...
> 用 XXD Panel 055 帮我处理这张图，先推荐最合适的构图和尺寸。
...
## 快速判断：XXD Panel 055 适合你吗？

| 你关心的问题 | 这套风格给你的回答 |
|---|---|
| **你会得到什么** | 把一束光、一个动作与一个空间关系画成温柔的视觉叙事 |
| **一眼可辨的特点** | 主体叙事 · 治愈粉彩 · 浅油画笔触 · 空气感蓝 · 编辑留白 |
...
这套风格先锁定照片中最有叙事力的主体、动作与空间关系，再主动删去不支撑氛围的环境信息。它不是给照片套一层粉彩滤镜，而是把可辨认的现实线索重新组织成有主次、有阅读路径的绘画式画面。

```text
锁定身份、轮廓、姿态与关系 → 选择最值得记住的叙事线索 → 压缩复杂场景 → 建立清晰视觉重心 → 用柔软粉彩块面与浅油画笔触重构 → 以空气感蓝和浅中性色维持呼吸 → 融入极少编辑文字
```

## 成品中最容易识别的风格特点

- 主体身份、关键姿态与叙事关系清楚可辨，但不完整照抄背景。
- 粗细克制的水粉、丙烯、粉蜡与浅油画刀痕共同形成柔软、明亮的手工触感。
- 浅粉蓝、雾蓝、天空蓝与象牙白、奶油白、浅米色构成轻盈主氛围，少量灰粉或柔桃色只作点睛。
- 主体可偏心、放大或局部裁切，靠层次、方向与安静留白建立清楚阅读路径。
- 文字少、小、轻，像独立出版物里的编辑注记，并且只从当前图片的内容与隐喻中产生。

原始审美约束与拒绝项只存在于[原始提示词](references/original-prompt/zh-CN.md)；Skill 与运行适配器只处理本次交付变量。 [Skill 工作流](SKILL.md) · [英文运行适配器](references/xxd-panel-055-prompt.en.md)
...
直接传入一个图片目录时，这个士兵 Skill 会自动批量处理目录中的图片，并让每张图片都使用 Panel 055 的同一套原始审美。默认递归扫描常见位图，先报告数量，再统一确认一次模式、尺寸、文字和语言；每张图片独立生成，互不借用内容或文案。整批仍然只创建一个扁平任务目录，单张失败会被记录，但不会静默跳过后续图片。
...
/xxd-panel-055 photo.jpg --mode top-bottom --size auto --text prompt --locale zh-CN
...
# 使用准确文案，不改写、不翻译、不补标题
/xxd-panel-055 photo.jpg --mode design-only --size 3:4 --copy "让风经过这里" --locale zh-CN

# 两种模式 × 三种尺寸，共生成六张独立完整构图
/xxd-panel-055 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale zh-CN

# 整个目录统一使用 Panel 055；公共设置只解析一次
/xxd-panel-055 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale zh-CN
...
Claude Code 用户可把同一文件夹链接到 `~/.claude/skills/xxd-panel-055`. 安装后请重启 Agent 会话。
...
完整规格: [Skill 工作流](SKILL.md) · [原始风格档案](references/original-prompt/zh-CN.md) · [英文运行适配器](references/xxd-panel-055-prompt.en.md) · [中文运行适配器](references/xxd-panel-055-prompt.zh-CN.md)
