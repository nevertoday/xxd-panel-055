...
Full specifications: [Skill workflow](SKILL.md) · [source archive](references/055-source.md) · [English runtime adapter](references/xxd-panel-055-prompt.en.md) · [Chinese runtime adapter](references/xxd-panel-055-prompt.zh-CN.md)
