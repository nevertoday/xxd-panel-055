...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091726763701555207"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 055 예시 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091726763701555207"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 055 예시 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091726763701555207"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 055 예시 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091726763701555207"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 055 예시 4"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 055 예시 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 055 예시 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 055 예시 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 055 예시 8"></td>
  </tr>
</table>

## 3:4 세로형 상하 구성 예시

위 16:9 예시와 같은 네 개의 독립 소스를 완전한 3:4 상하 캔버스로 다시 생성했습니다. 위쪽은 현실 사진을 유지하고 아래쪽은 Panel 055의 원본 프롬프트에 따라 재구성합니다. 영어 문구는 각 사진의 내용·분위기·함의에서만 생성했으며 모든 결과를 개별 검수했습니다.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 055 추가 상하 예시 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 055 추가 상하 예시 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 055 추가 상하 예시 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 055 추가 상하 예시 4"></td>
  </tr>
</table>

> [샤오샤오둥（@xiaoxiaodong01）](https://x.com/xiaoxiaodong01/status/2091726763701555207) · 2026년 8월 24일<br>
> GPT2 × 정제 × 치유 × 미학 프롬프트 × VOL.055

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2091726763701555207">원문 게시물과 전체 프롬프트 보기 →</a></p>

이 예시는 055의 미학적 결과만 보여 줍니다. 예시의 주제, 구성, 색상, 문구, 이전 캔버스 비율은 새 작업의 참고나 기본값이 되지 않습니다.
...
**Panel 055**은 원본 사진의 핵심을 보존하면서 다음과 같은 시각 방향을 원하는 작업에 적합합니다: **빛과 동작, 공간의 관계를 부드러운 시각 서사로**. 먼저 용도와 원하는 결과를 확인한 뒤 구성, 크기, 텍스트와 전달 형식을 결정합니다.
...
> XXD Panel 055으로 이 이미지를 작업하고, 먼저 가장 어울리는 구성과 크기를 추천해 줘.

시각 방향을 먼저 확인하려면 위 예시를 살펴보세요. 준비가 되면 [시작하기](#시작하기)로 이동할 수 있습니다. 전체 모드와 매개변수는 접이식 참고 자료에서 필요할 때 확인할 수 있습니다.
<!-- xxd-human-intro:end -->

<!-- xxd-panel-benefit:start -->
## 빠른 판단: XXD Panel 055이 나에게 맞을까요?

| 궁금한 점 | 이 스타일이 주는 답 |
|---|---|
| **얻게 되는 결과** | 빛과 동작, 공간의 관계를 부드러운 시각 서사로 |
| **한눈에 알아볼 특징** | 주체 서사 · 치유 파스텔 · 옅은 유화 붓결 · 공기감 있는 파랑 · 편집 여백 |
...
Claude Code 사용자는 같은 폴더를 다음 위치에 연결할 수 있습니다: `~/.claude/skills/xxd-panel-055`. 설치 후 에이전트 세션을 다시 시작하세요.
...
전체 사양: [Skill 워크플로](SKILL.md) · [원본 스타일 자료](references/original-prompt/zh-CN.md) · [영문 런타임 어댑터](references/xxd-panel-055-prompt.en.md) · [중문 런타임 어댑터](references/xxd-panel-055-prompt.zh-CN.md)
...
원본에서 가장 서사적인 주체와 동작, 공간 관계를 먼저 찾고 이를 돕지 않는 환경 정보는 덜어 냅니다. 단순한 파스텔 필터가 아니라 알아볼 수 있는 현실 단서를 위계와 읽기 흐름이 있는 회화적 구성으로 다시 조직합니다.

```text
정체성·윤곽·자세·관계 고정 → 기억할 서사 단서 선택 → 복잡한 장면 압축 → 하나의 초점 설정 → 부드러운 파스텔 색면과 옅은 유화 질감으로 재구성 → 공기감 있는 파랑과 옅은 중성색 유지 → 최소한의 편집 글자 통합
```

## 완성작에서 바로 알아볼 수 있는 스타일 특징

- 주체의 정체성, 핵심 자세, 서사 관계는 선명하게 남고 배경 전체를 그대로 베끼지 않습니다.
- 과슈, 아크릴, 파스텔과 절제된 페인팅 나이프 흔적이 부드럽고 밝은 수작업 표면을 만듭니다.
- 옅은 분청, 안개 파랑, 하늘색, 아이보리, 크림, 밝은 베이지가 주조를 이루며 탁한 분홍이나 부드러운 복숭아색은 작은 포인트입니다.
- 비대칭 배치, 확대, 부분 재단과 고요한 여백으로 분명한 읽기 흐름을 만듭니다.
- 글자는 작고 가벼운 편집 주석처럼 쓰이며 현재 이미지의 내용이나 함의에서만 나옵니다.

미적 제약과 금지 항목은 [원본 프롬프트](references/original-prompt/zh-CN.md)에만 있으며 Skill과 런타임 어댑터는 이번 출력 변수만 처리합니다. [Skill](SKILL.md) · [영문 런타임 어댑터](references/xxd-panel-055-prompt.en.md)
...
이미지 폴더를 직접 전달하면 이 병사 Skill이 같은 Panel 055의 원본 미학으로 일괄 처리합니다. 일반 래스터 형식을 기본적으로 재귀 탐색하고 수량을 먼저 알린 뒤 모드·크기·텍스트·언어를 한 번만 확인합니다. 각 이미지는 내용이나 문구가 섞이지 않도록 독립 생성하며 전체 배치는 하나의 평면 작업 디렉터리만 사용합니다. 개별 실패는 기록하고 이후 이미지를 조용히 누락하지 않습니다.
...
/xxd-panel-055 photo.jpg --mode top-bottom --size auto --text prompt --locale ko-KR

# 좌우 비교: 3:2 가로형, 글자 없음
/xxd-panel-055 photo.jpg --mode left-right --size 3:2 --text none

# 디자인 전용: 9:16 휴대폰 세로형, 한국어 문구
/xxd-panel-055 photo.jpg --mode design-only --size 9:16 --text prompt --locale ko-KR
...
/xxd-panel-055 photo.jpg --mode design-only --size 3:4 --text prompt --locale ko-KR

# 정확한 문구를 재작성·번역·제목 추가 없이 사용
/xxd-panel-055 photo.jpg --mode design-only --size 3:4 --copy "빛을 이곳에 남겨 두기" --locale ko-KR

# 2개 모드 × 3개 크기로 독립적인 완성 구도 6개 생성
/xxd-panel-055 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ko-KR

# 폴더 전체에 Panel 055 적용, 공통 설정은 한 번만 확정
/xxd-panel-055 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ko-KR
